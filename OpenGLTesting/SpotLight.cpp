...
void SpotLight::UseLight(GLuint ambientIntensityLocation, GLuint ambientColorLocation, GLuint diffuseIntesityLocation, 
...
void SpotLight::SetFlash(glm::vec3 pos, glm::vec3 dir, bool on)
{
	diffuseIntensity = on ? 2.0f : 0.0f;
	position = pos;
	direction = dir;
}
